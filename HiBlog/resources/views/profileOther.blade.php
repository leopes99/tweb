                                            ...
                                            <center>
                                                <div class="d-none d-md-block col-md-9">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <a href="{{route('eliminaAmicizia',['idOther'=>$utente[0]->id, 'id'=>Auth::user()->id])}}",  onclick="return confirm('Sicuro di voler eliminare {{$utente[0]->username}} dalla lista amici?')", id="pulsanteVediBlog">Rimuovi amico </a>
                                                    </div>
